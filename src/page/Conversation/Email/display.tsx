    ...
    <div className="flex h-full flex-col">
      ...
      {mail  ?  (
        <div className="flex flex-1 flex-col">
          <div className="flex items-start p-4">
            <div className="flex items-start gap-4 text-sm ">
              ...
              <div className="grid gap-1">
                <div className="font-semibold">{mail.from} <p><strong className="font-semibold text-sm">From:</strong> {mail.from}</p>
                </div>
                <div className="line-clamp-1 text-xs"><strong>Subject:</strong> {mail.subject}</div>
                <div className="line-clamp-1 text-xs">
                  <span className="font-medium">Reply-To:</span> {mail.inReplyTo}
                </div>
              </div>
            </div>
            {mail.date && (
          ...
          <Separator />
            <div className="flex-1 whitespace-pre-wrap max-h-[30rem] overflow-scroll  p-4  text-sm h-[50%] ">
            <div key={mail.html} dangerouslySetInnerHTML={{ __html: mail.html }} />
