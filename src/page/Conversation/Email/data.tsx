...
//     status: "send", // or "draft", "reply", "trash", "spam"
//   },
//   {
...
//     status: "reply", // or "draft", "send", "trash", "spam"
//   },
//   {
...
//     read: false,
//     labels: ["work", "budget"],
//     status: "draft", // or "send", "reply", "trash", "spam"
//   },
//   {
...
//     text: "I'd like your feedback on the latest project deliverables. Your insights are invaluable and will help us ensure that we're meeting our goals and expectations.\n\nI've attached the documents for your review.\n\nPlease provide your feedback at your earliest convenience, and let me know if there are any areas that require further attention.\n\nThank you! Daniel",
//     date: "2022-10-10T21:00:00",
//     read: false,
//     labels: ["work", "feedback"],
//     status: "draft", // or "send", "reply", "trash", "spam"
//   },
//   // 
//   {
...
//     read: true,
//     labels: ["meeting", "work", "important"],
//     status: "open", // or "draft", "reply", "trash", "spam"
//   },
//   {
//     id: "110e8400-e29b-11d4-a716-446655440000",
//     name: "Alice Smith",
...
//     read: true,
//     labels: ["work", "important"],
//     status: "bounce", // or "draft", "send", "trash", "spam"
//   },
//   {
//     id: "3e7c3f6d-bdf5-46ae-8d90-171300f27ae2",
//     name: "Bob Johnson",
...
//     read: true,
//     labels: ["personal"],
//     status: "check", // or "draft", "reply", "trash", "spam"
//   },
//   {
//     id: "61c35085-72d7-42b4-8d62-738f700d4b92",
//     name: "Emily Davis",
...
//     read: false,
//     labels: ["work", "budget"],
//     status: "trash", // or "send", "reply", "trash", "spam"
//   },
//   {
//     id: "8f7b5db9-d935-4e42-8e05-1f1d0a3dfb97",
//     name: "Michael Wilson",
...
//     read: false,
//     labels: ["meeting", "work", "important"],
//     status: "check", // or "send", "reply", "trash", "spam"
//   },
//   {
//     id: "2f0130cb-39fc-44c4-bb3c-0a4337edaaab",
//     name: "Olivia Wilson",
...
//     read: true,
//     labels: ["personal"],
//     status: "bounce", // or "draft", "reply", "trash", "spam"
//   },
//   {
//     id: "de305d54-75b4-431b-adb2-eb6b9e546014",
//     name: "James Martin",
...
//     read: true,
//     labels: ["work", "conference"],
//     status: "important", // or "draft", "reply", "trash", "spam"
//   },
//   {
//     id: "7dd90c63-00f6-40f3-bd87-5060a24e8ee7",
//     name: "Sophia White",
...
//     read: false,
//     labels: ["work", "feedback"],
//     status: "spam", // or "send", "reply", "trash", "spam"
//   },
// ];
