...
import { PostNewEmailTemplateAsync } from "../../../store/slices/eTemplate";
...
export default function AddEmailTemplate() {
    ...
    const handleSend = async () => {
        ...
        formData.append("template_name", templateName); // Add Template Name to FormData
        ...
        dispatch(PostNewEmailTemplateAsync(formData))
        // try {
    ...
    return (
        ...
        <div className="m-0 p-0 w-full">
            <div>
                <Input className="m-0 pl-5 " type="text" placeholder="Template Name" value={templateName}
                    onChange={(e) => setTemplateName(e.target.value)} />
                <Input className="mt-3 pl-5" type="text" placeholder="Write a subject line" value={subject}
