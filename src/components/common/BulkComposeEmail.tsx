...
const ComposeBulkEmail: React.FC<ComposeEmailProps> = ({
    open,
    handleClose,
    initialTo,
}) => {
    ...
    const handleSend = async () => {
        ...
        to.forEach((email, index) => {
            formData.append(`contacts[${index}]`, email);
        });
        ...
        try {
            const response = await axios.post(API_URL.POST_BULK_EMAIL,
                formData,
                {
                    headers: {
                ...
                <div className="flex gap-3">
                    ...
                    <div className="w-80 " >
                        <Select onValueChange={handleTemplateSelect}>
                            ...
                            <SelectContent className="absolute z-[10000] bg-white shadow-lg border border-gray-300 rounded-md"> {/* Adjust styles */}
                    ...
                    <div className='w-48 relative z-0'>
                        <Select onValueChange={handleTimeZoneChange} >
                            ...
                            <SelectContent className=" absolute z-[10000] bg-white shadow-lg border border-gray-300 rounded-md">
...
export default ComposeBulkEmail;
